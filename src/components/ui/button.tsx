...
import { ButtonProps as MyButtonProps } from "@/types/type";
...
type ButtonProps = React.ComponentPropsWithoutRef<typeof Pressable> &
  VariantProps<typeof buttonVariants> & MyButtonProps;

const Button = React.forwardRef<React.ElementRef<typeof Pressable>, ButtonProps>(
  ({ className, variant, size, IconLeft, title, IconRight, ...props }, ref) => {
    return (
      ...
      >
        <TouchableOpacity
          ...
          {...props}
        >
          {IconLeft && <IconLeft className='text-foreground' />}
          <Text>
            {title}
          </Text>
          {IconRight && <IconRight className='text-foreground' />}
        </TouchableOpacity>
      </TextClassContext.Provider>
    );
  }
